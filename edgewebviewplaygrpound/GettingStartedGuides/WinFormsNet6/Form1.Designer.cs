...
partial class Form1
{
    ...
    private void InitializeComponent()
    {
        ...
        this.webView.CreationProperties = new Microsoft.Web.WebView2.WinForms.CoreWebView2CreationProperties()
        {
            UserDataFolder = System.IO.Path.Combine(Environment.CurrentDirectory, "WebView2UserDataFolder")
        };        
